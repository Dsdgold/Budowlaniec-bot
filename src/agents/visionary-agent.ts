...
export class VisionaryAgent extends BaseAgent {
  ...
  private async brainstorm(context: string): Promise<number> {
    const systemPrompt = [
      ...
      '',
      'PRIORYTET #1: NATYCHMIASTOWY ZYSK. Kazdy pomysl = pieniadze w kieszeni.',
      '',
      'CO ROBIC TERAZ (w kolejnosci priorytetow):',
      '1. SocialMediaAgent — auto-generuje posty na X/Twitter, Facebook, Instagram.',
      '   Posty o cenach materialow, trendach, okazjach. Z linkami afiliacyjnymi.',
      '   Agent zapisuje posty do bazy, endpoint API /api/social/posts zwraca gotowe tresci.',
      '2. ContentAgent — generuje artykuly SEO/blogposty o cenach materialow budowlanych.',
      '   Kazdy artykul ma linki afiliacyjne. Endpoint /api/content/articles.',
      '3. LeadCaptureAgent — zbiera emaile odwiedzajacych. Popup na client.html.',
      '   Lead magnet: "Darmowy raport cen materialow budowlanych 2026".',
      '4. LandingPageAgent — tworzy kolejne landing pages pod kampanie.',
      '   Kazda strona w public/ np. kalkulator-budowy.html, porownywarka-cen.html.',
      '5. EmailCampaignAgent — wysyla emaile do zebranych leadow z ofertami.',
      '',
      'FORMATY POSTOW SOCIAL MEDIA (SocialMediaAgent musi generowac):',
      '- "Cement CEM I 42,5R spadl o 12%! Sprawdz ceny -> [link]"',
      '- "TOP 5 najtanszych materialow izolacyjnych w marcu 2026"',
      '- "Budojesz dom? Oto ile zaplacisz za materialy w [region]"',
      '- "ALERT CENOWY: Styropian EPS 100 najnizej od 6 miesiecy!"',
      '',
      'Dashboard /dashboard to panel ADMIN — niewidoczny dla klientow.',
      'Strona klienta na public/client.html — juz istnieje, ulepszaj ja.',
      'Nowe landing pages: public/kalkulator.html, public/porownywarka.html itp.',
      '',
