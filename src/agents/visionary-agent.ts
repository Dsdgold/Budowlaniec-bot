...
export class VisionaryAgent extends BaseAgent {
  ...
  private async brainstorm(context: string): Promise<number> {
    const systemPrompt = [
      ...
      '',
      'PRIORYTET #1: CONTENT NA STRONIE — posty, artykuly, trendy widoczne dla odwiedzajacych.',
      '',
      'CO ROBIC TERAZ:',
      '1. Stworz endpoint API /api/content/posts ktory zwraca posty social media z bazy.',
      '   Tabela: social_posts (id, title, content, hashtags, category, created_at).',
      '   Agent SocialContentAgent co godzine generuje 3-5 postow przez Claude Haiku.',
      '   Posty o cenach, trendach, okazjach, poradach budowlanych.',
      '2. Dodaj sekcje "Aktualnosci" na client.html — wyswietla posty z /api/content/posts.',
      '   Karty z postami, ladne formatowanie, hashtagi, data.',
      '3. Stworz strone public/blog.html — artykuly SEO o cenach materialow.',
      '   ContentAgent generuje artykuly, endpoint /api/content/articles.',
      '4. Stworz public/kalkulator.html — kalkulator kosztow budowy domu.',
      '   Formularz: metraz, standard, region -> szacunkowy koszt materialow.',
      '5. Rozbuduj client.html — dodaj sekcje: ostatnie posty, trending materialy,',
      '   formularz zapisu na newsletter, testimoniale, FAQ.',
      '',
      'FORMATY POSTOW (SocialContentAgent):',
      '- Trendy: "Cement CEM I 42,5R spadl o 12%! Najnizej od 6 mies."',
      '- Porady: "5 sposobow na oszczedzenie przy zakupie materialow izolacyjnych"',
      '- Alerty: "OKAZJA: Styropian EPS 100 w promocji -25% w Castoramie"',
      '- Rankingi: "TOP 3 najtansze hurtownie materialow w marcu 2026"',
      '- Porownania: "Castorama vs Leroy Merlin — gdzie tanszy cement?"',
      '',
      'WAZNE: content ma byc po POLSKU, profesjonalny, z konkretnymi liczbami.',
      'Kazdy post ma hashtagi: #materialybudowlane #budowa #cenybudowlane',
      '',
      'Admin dashboard na /dashboard. Strona klienta na /client.html.',
      'Nowe strony: /blog.html, /kalkulator.html.',
      '',
      'JAK DODAWAC CONTENT NA STRONE KLIENTA:',
      'Uzyj type="ui_change" z target_file="public/client.html".',
      'Executor wstawi kod HTML przed </body> w client.html.',
      'Generuj GOTOWE sekcje HTML z CSS w <style> i JS w <script>.',
      'Sekcje musza pobierac dane z API: /api/content/posts, /api/stats, /api/webapp/prices/cement',
      '',
