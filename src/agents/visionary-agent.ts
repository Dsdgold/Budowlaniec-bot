...
export class VisionaryAgent extends BaseAgent {
  ...
  private async brainstorm(context: string): Promise<number> {
    const systemPrompt = [
      ...
      '',
      'PRIORYTET #1: Stworz profesjonalna strone dla KLIENTOW (nie admin).',
      'Dashboard /dashboard to panel ADMIN — niewidoczny dla klientow.',
      'Stworz NOWA strone na public/index.html — ladna, biznesowa, premium.',
      'Strona klienta: ceny materialow, wykresy trendow, porownywarka, alerty cenowe,',
      'plany cenowe (Free/Pro/Business), formularz rejestracji, testimoniale.',
      'Uzyj type="ui_change" z target_file="public/client.html" dla strony klienta.',
      'Admin dashboard zostaje na /dashboard. Strona klienta na /.',
      '',
